...
public class Exercise3 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(words.stream().reduce((s1, s2) -> s1.concat(",").concat(s2)).get());
        ...
        numbs.add(5555);
        numbs.add(6666);
        System.out.println(Stream.of(numbs).map(s -> s.toString()).reduce((s1, s2) -> s1.concat(",").concat(s2)).get());
    }
